    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <p align="center"><img src="images/cloud.jpg" width="600" height="400" /></p>
          <div class="clr"></div>
        </div>
        <p class="pages">&nbsp;</p>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li class="active"><a href="ViewHashTable.jsp">View Hash Table</a></li>
			<li class="active"><a href="ViewFileRequest.jsp">View File Request</a></li>
			...
			<li class="active"><a href="ViewResults1.jsp">View File Time Delay Results</a></li>
			<li class="active"><a href="ViewResults2.jsp">View File Throughput Results</a></li>
           <li><a href="csprovider.jsp">Logout </a></li>
          </ul>
        </div>
      </div>
