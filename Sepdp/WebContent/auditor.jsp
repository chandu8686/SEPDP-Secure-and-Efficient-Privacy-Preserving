...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to Third Party Auditor Login </h2>
          <p>&nbsp;</p>
          <form action="authentication1.jsp?type=<%="auditor"%>" method="post" id="leavereply">
            <ol>
              <li>
                <span class="style8 style2">
                
                <label for="name"><strong>Name (required)</strong></label>
                </span><span class="style8"> </span><span class="style6"><span class="style7"> <strong>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><a href="usermain.jsp">User</a></li>
            <li><a href="auditor.jsp">Third Party Auditor</a></li>
            <li><a href="csprovider.jsp">Cloud Service Provider </a></li>
