...
<div class="main">
  <div class="header">
	...
	<div class="logo style1 style1">
        <h3 class="style2">SEPDP Secure and Efficient Privacy Preserving<br /> 
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="auditor.jsp"><span>Third Party Auditor</span></a></li>
  ...
  <tr>
    <td width="148" height="32" bgcolor="#FFFF00"><div align="center" class="style5">ID </div></td>
    <td width="108" bgcolor="#FFFF00"><div align="center" class="style5"><b>User</b></div></td>
    <td width="146" bgcolor="#FFFF00"><div align="center" class="style5"><b>File Name</b></div></td>
   
    <td width="124" bgcolor="#FFFF00"><div align="center" class="style5"><b>Task</b></div></td>
    <td width="170" bgcolor="#FFFF00"><div align="center" class="style5"><b>Date and Time</b></div></td>
  </tr>
